...
export default class CKEditor extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (prevProps.data !== props.data && editor.getData() !== props.data) {
      ...
      //             const newUrl = url.startsWith(HZERO_FILE)?url:`${HZERO_FILE}/v1/${organizationId}/files/redirect-url?bucketName=${props.bucketName}&access_token=${accessToken}&url=${encodeURIComponent(
      //               url
      //             )}`;
      //             let replaceImg = item;
